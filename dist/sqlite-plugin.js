...
},{"../lib/custom":9}],9:[function(require,module,exports){
'use strict';
...
},{"./websql/WebSQLDatabase":10,"argsarray":1,"immediate":13,"noop-fn":6}],10:[function(require,module,exports){
'use strict';
...
WebSQLDatabase.prototype._onTransactionComplete = function(err) {
  ...
  window.statuses.push('onTransactionComplete');
  var self = this;
...
},{"./WebSQLTransaction":12,"immediate":13,"noop-fn":6,"tiny-queue":19}],11:[function(require,module,exports){
'use strict';
...
function runAllSql(self) {
  ...
  window.statuses.push('runAllSql');
...
function WebSQLTransaction(websqlDatabase) {
  ...
  window.statuses.push('onTransactionStart');
...
},{"./WebSQLResultSet":11,"immediate":13,"noop-fn":6,"tiny-queue":19}],13:[function(require,module,exports){
'use strict';
var types = [
  require('./nextTick'),
  require('./mutation.js'),
...
SQLiteDatabase.prototype.exec = function exec(queries, readOnly, callback) {
  ...
  function onSuccess(rawResults) {
    window.statuses.push('res');
    window.statuses.push(rawResults);
  ...
  window.statuses.push('execing');
  window.statuses.push(queries);
